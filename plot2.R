#plot2.R is a data cleaning script following the instructions
...
plot(RDate,gap, main="",type="l",xlab="",ylab="Global Active Power (kilowatts)",lwd=1)

#copy the plot from the screen device to the PNG file device at 480x480 pixel size
#save as plot2.png
dev.copy(png,"plot2.png",height=480,width=480,units="px"); dev.off();
